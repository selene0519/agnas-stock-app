        ...
        <header className="mone-app-header flex h-12 shrink-0 items-center gap-2 border-b border-slate-800 bg-slate-900/60 px-3 backdrop-blur md:px-5">
          ...
          <div className="flex shrink-0 items-center gap-2">
            ...
            <button
              ...
              className="mone-header-button relative flex h-11 w-11 items-center justify-center overflow-hidden rounded-full text-slate-400 transition-[background-color,color,transform] hover:bg-slate-800/55 hover:text-white active:scale-[0.96]"
            >
              <Sun
                size={14}
            ...
            <div className="relative">
              <button
                ...
                type="button"
                className="mone-header-button relative flex h-11 w-11 items-center justify-center rounded-full text-slate-400 transition-[background-color,color,transform] hover:bg-slate-800/55 hover:text-white active:scale-[0.96]"
