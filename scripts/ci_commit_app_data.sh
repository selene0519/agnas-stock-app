...
stage_app_data() {
  ...
  git add reports/biotech_evidence.json reports/biotech_evidence_validation.json 2>/dev/null || true
  git add data/biotech_evidence_snapshots.jsonl data/biotech_evidence_events.jsonl 2>/dev/null || true
