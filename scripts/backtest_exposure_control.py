...
def run() -> dict:
    ...
    return {
        ...
        "caveats": [
            ...
            "2026-07-30: 국면 판정을 trend60단독으로 고친 뒤 재실행했다. "
            "라벨 결함 시절 '약세장 정지'는 -71.7%였고 지금은 +17.6%다 — 개선은 "
            "컸지만 여전히 상시 노출(+209.6%)에 못 미친다. 15년간 지수가 올랐고 "
            "빠져 있던 기간의 상승을 놓치기 때문이다(시장 타이밍의 전형적 결과).",
